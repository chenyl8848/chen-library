<template>
  <div class="find-password-step-one-form">
    <el-form ref="findPasswordForm" label-position="top" label-width="80px" :model="user">
      <el-form-item label="电子邮箱">
        <el-input v-model="user.email" placeholder="请输入您注册账户时的电子邮箱"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" class="btn-block" icon="Check" @click="handleFindPassword(findPasswordForm)" :loading="loading"
          :disabled="disabled">立即提交</el-button>
      </el-form-item>
      <div>
