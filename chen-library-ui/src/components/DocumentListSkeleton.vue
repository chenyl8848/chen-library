<template>
    <el-skeleton animated class="document-list ">
        <template #template>
            <ul>
                <li v-for="i in 1" :key="i">
                    <el-row :gutter="20">
                        <el-col :span="!settingStore.display.hide_keywords_on_lists || isMobile ? 4 : 3
                            " class="doc-cover">
                            <el-skeleton-item variant="image" :style="isMobile
                        ...
                        <el-col :span="!settingStore.display.hide_keywords_on_lists || isMobile ? 20 : 21
                            ...
                            <div class="doc-info">
                                ...
                                <el-skeleton-item variant="text" style="width: 45%; float: right" />
                            </div>
                            <div class="doc-desc">
