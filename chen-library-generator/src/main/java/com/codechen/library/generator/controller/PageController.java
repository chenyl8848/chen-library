...
public class PageController {
    ...
    public String indexPage(Model model) {
        List<TableInfo> tableInfoList = dataSourceService.tableList();
    ...
    @ResponseBody
    public Map<String, String> generateCodeString(@PathVariable String tableName) {
